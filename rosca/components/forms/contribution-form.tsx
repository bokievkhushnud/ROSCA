...
import type { ContributionStatus, ContributionType, User } from "@prisma/client";
...
export default function ContributionForm({ initialData, onSubmit, users }: ContributionFormProps) {
